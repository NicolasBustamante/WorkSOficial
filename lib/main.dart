...
class MyApp extends StatelessWidget {
  ...
  final routes = {
    ...
    '/home-page': (BuildContext context) => new Home(),
    '/first-page': (BuildContext context) => new Firstpage(),
    '/perfil-page': (BuildContext context) => new Perfil(),
    '/solicituds-page': (BuildContext context) => new Solicitudes(),
    '/pago-page': (BuildContext context) => new Pago(),
